		...
		<div class="w3-agileits-about-grids">
			...
			<div class="col-md-12 agile-about-left">
				<table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php
$query=mysqli_query($con,"INSERT INTO locker (lockerid)values($searchby)");
 $query=mysqli_query($con,"select * from tblassignlocker where LockerNumber='$searchby' || KeyNumber='$searchby'"); 
$cnt=1;
